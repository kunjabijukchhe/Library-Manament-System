...
class Rem(Tk):
    def __init__(self):
        ...
        Label(self, text='Remove User', fg='black', bg="#20c997", font=("Helvetica Neue", 20, 'bold')).place(x=80, y=25)
        Label(self, text="Enter User Id: ", bg="#343a40",fg='#f8f9fa', font=('Helvetica Neue', 15, 'bold')).place(x=10, y=100)
